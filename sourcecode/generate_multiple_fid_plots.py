""" Script for generating the plot of the FID SCORE values (with min annotated) """
...
def annot_min(x, y, ax=None, y_offset=0.96):
    """
    ...
    ax.annotate(text, xy=(xmin, ymin), xytext=(0.94, y_offset), **kw)
