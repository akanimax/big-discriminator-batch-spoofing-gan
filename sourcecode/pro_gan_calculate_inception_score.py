...
files_path = "/data/_GENERATED/Pro-GAN/flowers/models/"
backup_file = "/data/_GENERATED/Pro-GAN/flowers/inception_scores.txt"
total_range = 204
start = 81
tot_images = 5000
start_depth = 6
...
# go over the depths of the models:
for cur_depth in range(start_depth, depth):
    ...
    for epoch in range(start, total_range + 1):
