#!/usr/bin/env python3
"""
AKANIMAX note: Due respect given to original writer as below: :)
...
def parse_arguments():
    ...
    :return: args => parsed cmd-line args
    """
...
def main(args):
    """
    Main function for the script (in script mode)
    :param args: parsed default command line arguments
    :return: None
    """
